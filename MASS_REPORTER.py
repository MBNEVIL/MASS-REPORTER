...
{b+Fore.GREEN} {1} > {Fore.RESET}illegal Content {b+Fore.RED}::{Fore.RESET} 1
{b+Fore.BLUE} {2} > {Fore.RESET}Harrassment {b+Fore.GREEN}::{Fore.RESET} 2
{b+Fore.RED} {3} > {Fore.RESET}Spam or Phishing Links {b+Fore.BLUE}::{Fore.RESET} 3
{b+Fore.GREEN} {4} > {Fore.RESET}Self harm {b+Fore.RED}::{Fore.RESET} 4
{b+Fore.BLUE} {5} > {Fore.RESET}NSFW Content {b+Fore.GREEN}::{Fore.RESET} 5
""")
...
if r.status_code == 200:
        ...
        input()
reportAmount = input(f"{b+Fore.BLUE} > how many reports do you wanna send{Fore.RESET}: ")
sleepAmount = input(f"{b+Fore.BLUE} > how many seconds in between do you wanna wait{Fore.RESET}: ")
